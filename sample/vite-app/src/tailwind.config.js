...
var config = {
    ...
    theme: {
        ...
        height: function (theme) { return (__assign(__assign({ auto: 'auto' }, theme('spacing')), { '1/2': '50%', '1/3': '33.333333%', '2/3': '66.666667%', '1/4': '25%', '2/4': '50%', '3/4': '75%', '1/5': '20%', '2/5': '40%', '3/5': '60%', '4/5': '80%', '1/6': '16.666667%', '2/6': '33.333333%', '3/6': '50%', '4/6': '66.666667%', '5/6': '83.333333%', full: '100%', screen: '100vh' })); },
        inset: function (theme, _a) {
            var negative = _a.negative;
            return (__assign(__assign(__assign({ auto: 'auto' }, theme('spacing')), negative(theme('spacing'))), { '1/2': '50%', '1/3': '33.333333%', '2/3': '66.666667%', '1/4': '25%', '2/4': '50%', '3/4': '75%', full: '100%', '-1/2': '-50%', '-1/3': '-33.333333%', '-2/3': '-66.666667%', '-1/4': '-25%', '-2/4': '-50%', '-3/4': '-75%', '-full': '-100%' }));
        },
        keyframes: {
            spin: {
                to: {
        ...
        maxHeight: function (theme) { return (__assign(__assign({}, theme('spacing')), { full: '100%', screen: '100vh' })); },
        maxWidth: function (theme, _a) {
            var breakpoints = _a.breakpoints;
            return (__assign({ none: 'none', 0: '0rem', xs: '20rem', sm: '24rem', md: '28rem', lg: '32rem', xl: '36rem', '2xl': '42rem', '3xl': '48rem', '4xl': '56rem', '5xl': '64rem', '6xl': '72rem', '7xl': '80rem', full: '100%', min: 'min-content', max: 'max-content', prose: '65ch' }, breakpoints(theme('screens'))));
        },
        minHeight: {
            0: '0px',
            full: '100%',
        ...
        ringColor: function (theme) { return (__assign({ DEFAULT: theme('colors.blue.500', '#3b82f6') }, theme('colors'))); },
        ...
        ringOpacity: function (theme) { return (__assign({ DEFAULT: '0.5' }, theme('opacity'))); },
        ringWidth: {
            DEFAULT: '3px',
            0: '0px',
            1: '1px',
        ...
        transitionProperty: {
            none: 'none',
            all: 'all',
            DEFAULT: 'background-color, border-color, color, fill, stroke, opacity, box-shadow, transform, visibility, display',
        ...
        translate: function (theme, _a) {
            var negative = _a.negative;
            return (__assign(__assign(__assign({}, theme('spacing')), negative(theme('spacing'))), { '1/2': '50%', '1/3': '33.333333%', '2/3': '66.666667%', '1/4': '25%', '2/4': '50%', '3/4': '75%', full: '100%', '-1/2': '-50%', '-1/3': '-33.333333%', '-2/3': '-66.666667%', '-1/4': '-25%', '-2/4': '-50%', '-3/4': '-75%', '-full': '-100%' }));
        },
